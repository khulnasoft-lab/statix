...
require (
	...
	github.com/containerd/containerd v1.7.19 // replace
	github.com/containerd/nerdctl v0.20.0
	github.com/docker/docker v27.0.3+incompatible // replace
...
require (
	...
	github.com/containerd/stargz-snapshotter v0.14.1 // indirect
...
replace github.com/aquasecurity/defsec => github.com/khulnasoft-lab/defsec v0.68.1
