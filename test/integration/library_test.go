...
import (
	...
	_ "github.com/khulnasoft-lab/statix/analyzer/all"
	"github.com/khulnasoft-lab/statix/applier"
	"github.com/khulnasoft-lab/statix/artifact"
	aimage "github.com/khulnasoft-lab/statix/artifact/image"
	"github.com/khulnasoft-lab/statix/cache"
	_ "github.com/khulnasoft-lab/statix/handler/all"
...
func TestStatix_Library_DockerLessMode(t *testing.T) {
...
func TestStatix_Library_DockerMode(t *testing.T) {
	for _, tc := range testCases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
...
func TestStatix_Library_TarMode(t *testing.T) {
	for _, tc := range testCases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
