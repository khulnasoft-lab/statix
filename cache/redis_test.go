...
func TestRedisCache_PutArtifact(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantKey: "statix::artifact::sha256:8652b9f0cb4c0599575e5a003f5906876e10c1ceb2ab9fe1786712dac14a50cf",
		},
		{
			name:       "no such host",
			setupRedis: false,
...
func TestRedisCache_PutBlob(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantKey: "statix::blob::sha256:03901b4a2ea88eeaad62dbe59b072b28b6efa00491962b8741081c5df50c65e0",
		},
		{
			name:       "no such host",
			setupRedis: false,
...
func TestRedisCache_GetArtifact(t *testing.T) {
	...
	s.Set("statix::artifact::sha256:8652b9f0cb4c0599575e5a003f5906876e10c1ceb2ab9fe1786712dac14a50cf", string(b))
	s.Set("statix::artifact::sha256:961769676411f082461f9ef46626dd7a2d1e2b2a38e6a44364bcbecf51e66dd4", "foobar")
...
func TestRedisCache_GetBlob(t *testing.T) {
	...
	require.NoError(t, err)
	s.Set("statix::blob::sha256:03901b4a2ea88eeaad62dbe59b072b28b6efa00491962b8741081c5df50c65e0", string(b))
	s.Set("statix::blob::sha256:961769676411f082461f9ef46626dd7a2d1e2b2a38e6a44364bcbecf51e66dd4", "foobar")
...
func TestRedisCache_MissingBlobs(t *testing.T) {
	...
	s.Set("statix::artifact::sha256:8652b9f0cb4c0599575e5a003f5906876e10c1ceb2ab9fe1786712dac14a50cf/1",
		fmt.Sprintf("{\"SchemaVersion\": %d}", types.ArtifactJSONSchemaVersion))
	s.Set("statix::artifact::sha256:be4e4bea2c2e15b403bb321562e78ea84b501fb41497472e91ecb41504e8a27c/1",
		`{"SchemaVersion": 999999}`) // This version should not match the current version
	s.Set("statix::blob::sha256:03901b4a2ea88eeaad62dbe59b072b28b6efa00491962b8741081c5df50c65e0/11111",
		fmt.Sprintf("{\"SchemaVersion\": %d}", types.BlobJSONSchemaVersion))
	s.Set("statix::blob::sha256:174f5685490326fc0a1c0f5570b8663732189b327007e47ff13d2ca59673db02/11111",
		`{"SchemaVersion": 999999}`) // This version should not match the current version
...
func TestRedisCache_Clear(t *testing.T) {
	...
	for i := 0; i < 200; i++ {
		s.Set(fmt.Sprintf("statix::key%d", i), "value")
	}
	s.Set("foo", "bar")
	...
	t.Run("clear", func(t *testing.T) {
		...
		for i := 0; i < 200; i++ {
			assert.False(t, s.Exists(fmt.Sprintf("statix::key%d", i)))
		}
...
func TestRedisCache_DeleteBlobs(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantKey: "statix::blob::" + correctHash,
		},
		{
			name:       "no such host",
			setupRedis: false,
